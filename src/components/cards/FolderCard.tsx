...
export function FolderCard({ folder }: FolderCardProps) {
  ...
  return (
    <Card className="group bg-surface hover:bg-surface/50  shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer" onClick={() => goToFolder(folder?._id)}>
